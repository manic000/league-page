...
<div class="wrapper">
    <h2>RA Trade Calculator</h2>
    <p class="meta">
        Type a name to autocomplete. Add as many players or picks as you want on each side.
        Values from <a href="https://rosteraudit.com" target="_blank" rel="noreferrer">RosterAudit</a> (1QB, Half-PPR).
        This calculator only calculates CURRENT value of trade assets.
    </p>
    {#if loadError}
